...
export function Movie({ name, image, summary, director,film, stars, rating,deletebutton,editbutton, id }) {
  ...
  return (
    <Card id="main">
      ...
      <CardContent id="content">
        <div className="tit" ><h2>{name}</h2><span style={styles}><i class="fa fa-star"></i> <b style={{fontSize: "22px"}}>{rating}</b>/10</span></div>
        <span>
          <p className="sum">{film}</p>
        </span><br />
